...
function CatalogueCards(props){
    return(
        <div className={catalogueCardsStyles.CatalogueSection__productionCards__item}>
            <a href='/catalogue?seWork=1' className={catalogueCardsStyles.link}>
            ...
            <a href='/catalogue?seWork=2' className={catalogueCardsStyles.link}>
            ...
            <a href='/catalogue?seWork=3' className={catalogueCardsStyles.link}>
            ...
            <a href='/catalogue?seWork=4' className={catalogueCardsStyles.link}>
